		...
		.ready(
				function() {
					...
					function myFunction1(response) {
						...
						out += "<label for=\"name\">"
								+ "\"New SMS load Window :\"" + "</label>"
								+ "<input class=\"form-control\" " + "value="
								+ "\"" + arr[0].NewSMSLoadWindow + "\""
								+ "type=\"time\" step=\"any\""
								+ "id=\"name\" /></div>";
						...
						out += "<div class=\"form-group\">";
						out += "<label for=\"name\">"
								+ "\"RetrysameGateway :\"" + "</label>"
								+ "<input class=\"form-control\"" + "value="
								+ arr[0].RetrysameGateway
								+ " id=\"name\" /></div>";

						out += "<div class=\"form-group\">";
						out += "<label for=\"name\">"
								+ "\"SMS status wait time :\"" + "</label>"
								+ "<input class=\"form-control\" " + "value="
								+ "\"" + arr[0].SMSstatuswaittime + "\""
								+ "id=\"name\" /></div>";
						...
						out += "<label for=\"name\">"
								...
								+ "</label>" + "<input class=\"form-control\""
								+ "value=" + arr[0].NextSMSloadinginterval
								+ " id=\"name\" /></div>";

						out += "<div class=\"form-group\">";
						out += "<label for=\"name\">"
								+ "\"Next SMS Batch loading interval :\""
								+ "</label>" + "<input class=\"form-control\" "
								+ "value=" + "\""
						...
						out += "<div class=\"form-group\">";
						out += "<label for=\"name\">"
								+ "\"Status poll retry limit :\"" + "</label>"
								+ "<input class=\"form-control\"" + "value="
								+ "\"" + arr[0].Statuspollretrylimit + "\""
								+ " id=\"name\" /></div>";
						...
						out += "<label for=\"name\">"
								...
								+ "</label>" + "<input class=\"form-control\""
								+ "value="
								+ arr[0].Gatewaystatuscheckertaskinterval
								+ " id=\"name\" /></div>";
